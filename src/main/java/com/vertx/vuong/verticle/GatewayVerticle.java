...
//		
//		router.get("/api/v1/hello").handler(this::validate).handler(this::hello);
//		
...
//		System.out.println(String.format("Request Validate: /api/v1/hello: %s", Thread.currentThread().getName()));
//		ctx.next();
//	}
//	
